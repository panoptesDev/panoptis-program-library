...
async fn test_withdraw_fixed_amount() {
    ...
    const PANO_DEPOSIT_AMOUNT_LAMPORTS: u64 = 200 * LAMPORTS_TO_PANO * INITIAL_COLLATERAL_RATIO;
    ...
    const WITHDRAW_AMOUNT: u64 = 100 * LAMPORTS_TO_PANO * INITIAL_COLLATERAL_RATIO;
    ...
    assert_eq!(
        ...
        PANO_DEPOSIT_AMOUNT_LAMPORTS - WITHDRAW_AMOUNT
    );
}
...
async fn test_withdraw_too_large() {
    ...
    const USDC_BORROW_AMOUNT_FRACTIONAL: u64 = 1_000 * FRACTIONAL_TO_USDC;
    const PANO_RESERVE_COLLATERAL_LAMPORTS: u64 = 2 * PANO_DEPOSIT_AMOUNT_LAMPORTS;
    const WITHDRAW_AMOUNT: u64 = (100 * LAMPORTS_TO_PANO * INITIAL_COLLATERAL_RATIO) + 1;
